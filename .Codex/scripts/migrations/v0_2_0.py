...
update slash-command references in AGENTS.md / README.md.
...
def plan(root: Path) -> list[Action]:
    ...
    snapshot = root / ".Codex" / "commands.pre-v0.2.0"
    ...
    for name in TEXT_TARGETS + ("RELEASE.md", ".Codex/TIPS.md"):
        f = root / name

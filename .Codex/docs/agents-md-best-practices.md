...
- Split into topic files using `.Codex/rules/*.md` for large projects.
...
## What goes in AGENTS.md vs PROJECT.md (GSD) vs IDENTITY.yaml

- **AGENTS.md** — coding rules, conventions, "what NOT to do", architecture pointers. Read every turn.

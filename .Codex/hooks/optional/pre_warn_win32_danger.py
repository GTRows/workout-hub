...
To enable: register this script in .Codex/settings.json under PreToolUse matcher "Write|Edit":
    "command": "python3 \"${CODEX_PROJECT_DIR}/.Codex/hooks/optional/pre_warn_win32_danger.py\""

Exit 2 = block + send stderr as feedback to Codex.
"""

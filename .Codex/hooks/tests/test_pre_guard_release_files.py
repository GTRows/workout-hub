...
def test_exempt_dir_unblocks_command_files():
    assert pre_guard.is_protected(".Codex/commands/release.md") is False
    assert pre_guard.is_protected(".Codex/commands/changelog.md") is False
    assert pre_guard.is_protected(".Codex/scripts/manifest.py") is False
    assert pre_guard.is_protected(".Codex/hooks/pre_guard_security.py") is False

---
name: "source-command-gtr-new-adr"
description: "[TEMPLATE] Scaffold a new Architecture Decision Record under docs/adr/."
---

# source-command-gtr-new-adr

Use this skill when the user asks to run the migrated source command `gtr-new-adr` or `/gtr:new-adr`.

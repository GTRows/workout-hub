---
name: "source-command-gtr-new-migration"
description: "[TEMPLATE] Scaffold a new database migration matching the project's detected migration tool."
---

# source-command-gtr-new-migration

Use this skill when the user asks to run the migrated source command `gtr-new-migration` or `/gtr:new-migration`.

...
// @EnableWebSecurity is now required under Spring Boot 4 / Spring Security 7
// because the modular autoconfigure split no longer auto-exposes HttpSecurity
// from spring-boot-starter-security alone.
@Configuration
@EnableWebSecurity
